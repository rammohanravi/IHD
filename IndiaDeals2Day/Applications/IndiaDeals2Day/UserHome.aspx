<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserHome.aspx.cs" Inherits="UserHome" EnableViewStateMac="false"%>
...
<body>
    ...
    <td colspan = "3" align = "center" class="style1">
        ...
        <td colspan = "5" align = "center"> 
            <asp:Button ID="btnDeals" runat="server" Text="Deals"/>
            <asp:Button ID="btnCoupons" runat="server" Text="Coupons" />
